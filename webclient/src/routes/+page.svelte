...
<div class="dark:bg-gray-900 dark:text-white h-screen">
	...
	<ul>
		{#each data.databases as database}
			<li><a href="/database/{database}">{database}</a></li>
		{/each}
	</ul> -->
							...
							>
								{#each data.databases as database}
									<tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
										<td
											class="py-4 px-6 text-sm font-medium text-center text-gray-900 whitespace-nowrap dark:text-white"
										>
											<a href="/databases/{database}">{database}</a>
										</td>
									</tr>
								{/each}
							</tbody>
